//! Generate a random name, using the docker algorithm

/// Left part of random name
static LEFT: &[&str] = &[
    "admiring",
    "adoring",
    "affectionate",
...
pub fn random_name() -> String {
    ...
    format!(
        "{}_{}",
        LEFT.choose(&mut rand::thread_rng()).unwrap(),
        RIGHT.choose(&mut rand::thread_rng()).unwrap()
    )
}
